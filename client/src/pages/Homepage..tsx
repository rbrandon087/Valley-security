              ...
              <div className="relative overflow-hidden rounded-lg">
                <div className="absolute inset-0">
                  <img
                    ...
                    alt=""
                    className="h-full w-full object-cover object-center transform transition duration-300 hover:scale-105"
                  />
                </div>
                <div className="relative  bg-opacity-75 px-6 py-16 sm:px-12 sm:py-20 lg:px-16">
                  <div className="relative mx-auto flex max-w-xs flex-col items-center text-center">
                    <h2
                      id="comfort-heading-1"
                      className=" font-bold tracking-tight text-white sm:text-2xl "
                    >
                      Commercial
                    </h2>
                    <p className="mt-3 text-lg text-white"></p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden rounded-lg">
                <div className="absolute inset-0">
                  <img
                    src="https://tailwindui.com/img/ecommerce-images/home-page-01-feature-section-02.jpg"
                    alt=""
                    className="h-full w-full object-cover object-center transform transition duration-300 hover:scale-50"
                  />
                </div>
                <div className="relative bg-opacity-75 px-6 py-16 sm:px-12 sm:py-20 lg:px-16">
                  <div className="relative mx-auto flex max-w-xs flex-col items-center text-center">
                    <h2
                      id="comfort-heading-2"
